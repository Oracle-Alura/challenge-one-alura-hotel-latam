...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		// Botón salir que debe llevar a la ventana de login (Alejandra).
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				dispose(); // Cierra la ventana actual (MenuUsuario)
				Login login = new Login(); // Crea una instancia de la ventana de inicio de sesión
